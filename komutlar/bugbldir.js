...
let channel = bot.channels.cache.get("813354750929797209")//bug repot kanal id'i
...
message.channel.send("<a:bildirim:810789256569159690>  **| Bug Report Başarı İle İletildi.**")
